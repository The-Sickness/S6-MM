...
cortexbrain_kernel=$(cat /res/synapse/Sickness/cortexbrain_kernel);
cortexbrain_system=$(cat /res/synapse/Sickness/cortexbrain_system);
cortexbrain_wifi_auto=$(cat /res/synapse/Sickness/cortexbrain_wifi_auto);
cortexbrain_media_manager=$(cat /res/synapse/Sickness/cortexbrain_media_manager);
cortexbrain_nmi_auto=$(cat /res/synapse/Sickness/cortexbrain_nmi_auto);
